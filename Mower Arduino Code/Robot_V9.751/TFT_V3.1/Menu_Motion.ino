void Print_Motion_Menu() {  
    ...
    if (Robot_Type == 1) OPTION2_BTN.initButton(&tft, Button_X, Button_Y, Button_W, Button_H, RED, WHITE, BLACK, "Blade >", 2);
    if (Robot_Type == 2) OPTION2_BTN.initButton(&tft, Button_X, Button_Y, Button_W, Button_H, RED, WHITE, BLACK, "Drill >", 2);
