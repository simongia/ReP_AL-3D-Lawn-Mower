...
void Print_Testing_3_Menu() {
    ...
    Test1_btn.initButton(&tft, Button_X, Button_Y, Button_W, Button_H, YELLOW, YELLOW, BLACK, "Tilt >", 2);
    ...
    Test2_btn.initButton(&tft, Button_X, Button_Y, Button_W, Button_H, WHITE, WHITE, BLACK, "GYRO >", 2);
    ...
    Test3_btn.initButton(&tft, Button_X, Button_Y, Button_W, Button_H, RED, RED, WHITE, "Wheel Amp", 2);
    ...
    if (Robot_Type == 2) {
        Test4_btn.initButton(&tft, Button_X, Button_Y, Button_W, Button_H, MAGENTA, MAGENTA, WHITE, "Drill Lift", 2);
        Test4_btn.drawButton(false);
        }
    ...
    if (GPS_Enabled == 0) Test5_btn.initButton(&tft, Button_X, Button_Y, Button_W, Button_H, BLUE, MAGENTA, WHITE, "SPARE", 2);
    if (GPS_Enabled == 1) Test5_btn.initButton(&tft, Button_X, Button_Y, Button_W, Button_H, BLUE, MAGENTA, WHITE, "PIXHAWK", 2);
...
// Test 5 - PIXHAWK Test
 if (Test5_btn.justPressed()) {
          ...
          // Sense for the settings buttons until the saved button is pressed.
          while (Menu_Complete_Pixhawk_Menu == false) {
