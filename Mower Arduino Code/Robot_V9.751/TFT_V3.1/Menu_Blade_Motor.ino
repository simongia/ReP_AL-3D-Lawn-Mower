void Print_Blade_Motor_Menu() {  
    ...
    if (Draw_Pictures == 1)   {
      if (Robot_Type == 1) bmpDraw("Motors.bmp", 70, 20);      //Draw the mower picture
      if (Robot_Type == 2) bmpDraw("Motors.bmp", 70, 20);      //Draw the mower picture 
    }
    delay(100); 
...
// Create Bars for the Motor Values
  ...
  int Txt_Size_Label = 2;                       // Text size of the battery % text
    ...
    if (Robot_Type ==  1) tft.print(F("Blade Motor Settings"));  
    if (Robot_Type ==  2) tft.print(F("Drill Motor Settings"));
  ...
  if (Robot_Type == 1) tft.print(F("Blade"));
  if (Robot_Type == 2) tft.print(F("Drill"));
  ...
  if (Robot_Type == 2) {
      if (Cutting_Blades_Activate == 1) OPTION1_BTN.initButton(&tft, 235, 278, 150, 40, WHITE, GREEN, BLACK, "DRILL ON", 2);
      if (Cutting_Blades_Activate == 0) OPTION1_BTN.initButton(&tft, 235, 278, 150, 40, WHITE, RED, WHITE, "DRILL OFF", 2);
      }
...
if (OPTION1_BTN.justPressed() )  {
        ...
        if ((Cutting_Blades_Activate == 1) && (Changed == 0))  {
          ...
          Changed = 1;
          if (Robot_Type == 1 ) OPTION1_BTN.initButton(&tft, 235, 278, 150, 40,  WHITE, RED, WHITE, "BLADE OFF", 2);
          if (Robot_Type == 2 ) OPTION1_BTN.initButton(&tft, 235, 278, 150, 40,  WHITE, RED, WHITE, "DRILL OFF", 2);
          OPTION1_BTN.drawButton(false);
          }
        ...
        if ((Cutting_Blades_Activate  == 0) && (Changed == 0)) {
          ...
          Changed = 1;
          if (Robot_Type == 1 )  OPTION1_BTN.initButton(&tft, 235, 278, 150, 40,  RED, GREEN, BLACK, "BLADE ON", 2);
          if (Robot_Type == 2 )  OPTION1_BTN.initButton(&tft, 235, 278, 150, 40,  RED, GREEN, BLACK, "DRILL ON", 2);
          OPTION1_BTN.drawButton(false);
        }    
   }
