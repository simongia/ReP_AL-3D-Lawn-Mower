...
//Wheels ON/OFF Button  //  RVES added
    ...
    if (Robot_Type == 1) {
        if (Wheels_Activate == 1) OPTION1_BTN.initButton(&tft, 230, 200, 165, 40, WHITE, GREEN, BLACK, "WHEELS ON", 2);
        if (Wheels_Activate == 0) OPTION1_BTN.initButton(&tft, 230, 200, 165, 40, WHITE, RED, WHITE, "WHEELS OFF", 2);
        }
